...
OBJ = resolve_file.o stack.o queue.o graph.o path.o main.o
#attention, the test_h.c and graphics.c should delete from SRC, it should compile seperately.
SRC = resolve_file.c stack.c queue.c graph.c path.c main.c

Header = resolve_file.h stack.h queue.h vertex.h edge.h graph.h path.h
